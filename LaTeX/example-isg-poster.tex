...
\solutionDescription{Using the beamer style file created for use at the RHUL Information Security Group Open Day.  With this style file you can painlessly create a nice looking poster to present at the open day (I hope).  Here is presented an example poster that shows off this style.}
	...
	\begin{column}{.32\textwidth}
		...
		\begin{centreColumnBlock}{Logos}
			...
			\begin{itemize}
				...
				\item This will be inserted to the right of the poster title.
